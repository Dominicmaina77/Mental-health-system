...
<head>
    ...
    <title>Dashboard - SootheSpace 🌸</title>
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card daily-quote">
                    ...
                    <div class="quote-content">
                        <p class="quote-text">"Your feelings are valid, and they matter. Take a moment to breathe. 🌸"</p>
                        <p class="quote-author">- SootheSpace Care Team</p>
                    </div>
                ...
                <div class="dashboard-card wellness-tip">
                    ...
                    <p class="tip-content">Take 5 deep breaths when you feel overwhelmed. Inhale peace, exhale stress. 🌬️</p>
                </div>
            </div>
        </div>
    </section>
