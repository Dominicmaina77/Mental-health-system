...
<body>
    ...
    <script>
        ...
        function updateCharts() {
            ...
            // Wait for the DOM to be fully loaded before accessing canvas elements
            setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                // Get chart type from filter
                const chartType = document.getElementById('chart-type') ? document.getElementById('chart-type').value : 'doughnut';
        ...
        function setupFilterEventListeners() {
            ...
            const moodRangeEl = document.getElementById('mood-range');
            const dataCategoryEl = document.getElementById('data-category');

            if (dateRangeEl) {
                dateRangeEl.addEventListener('change', function() {
                    const selectedValue = this.value;
                    // Reload the page with the new date range
                    window.location.href = `insights.php?date_range=${selectedValue}&chart_type=${chartTypeEl ? chartTypeEl.value : 'line'}&mood_range=${moodRangeEl ? moodRangeEl.value : 'all'}&data_category=${dataCategoryEl ? dataCategoryEl.value : 'all'}`;
                });
            }
            ...
            if (chartTypeEl) {
                chartTypeEl.addEventListener('change', function() {
                    ...
                    window.location.href = `insights.php?date_range=${dateRangeEl ? dateRangeEl.value : '30'}&chart_type=${selectedValue}&mood_range=${moodRangeEl ? moodRangeEl.value : 'all'}&data_category=${dataCategoryEl ? dataCategoryEl.value : 'all'}`;
                });
            }

            if (moodRangeEl) {
                moodRangeEl.addEventListener('change', function() {
                    const selectedValue = this.value;
                    // Reload the page with the new mood range
                    window.location.href = `insights.php?date_range=${dateRangeEl ? dateRangeEl.value : '30'}&chart_type=${chartTypeEl ? chartTypeEl.value : 'line'}&mood_range=${selectedValue}&data_category=${dataCategoryEl ? dataCategoryEl.value : 'all'}`;
                });
            }

            if (dataCategoryEl) {
                dataCategoryEl.addEventListener('change', function() {
                    const selectedValue = this.value;
                    // Reload the page with the new data category
                    window.location.href = `insights.php?date_range=${dateRangeEl ? dateRangeEl.value : '30'}&chart_type=${chartTypeEl ? chartTypeEl.value : 'line'}&mood_range=${moodRangeEl ? moodRangeEl.value : 'all'}&data_category=${selectedValue}`;
                });
            }
        }
